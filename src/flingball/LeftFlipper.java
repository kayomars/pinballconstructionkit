...
/**
 * Mutable Gadget representing flipper turning counter-clockwise
 *
 */
public class LeftFlipper implements Gadget {
    ...
    // AF(name, orientation, flipper, curAngle, state, triggers) = a left flipper with name name, 
    ...
    /**
     * Creates a new Left Flipper gadget with top-left at (xPos, yPos)
     ...
     */
    public LeftFlipper(String name, double xPos, double yPos, Orientation orientation) {
        this.name = name;
    ...
    /**
     * @return LeftFlipper [orientation=orientation, name=name, flipper=flipper]
     */
    ...
    @Override public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LeftFlipper other = (LeftFlipper) obj;
        if (curAngle == null) {
